...
public class Utils {
    ...
    public static TaskDescription parseMessageFromRest(Message<JsonObject> payload) {
        ...
        return new TaskDescription(
                UUID.fromString(mqMetadata
                        .getHeader(Attributes.Rest.USER_ID, String.class)
                        .orElse("")),
                ...
                UUID.fromString(mqMetadata
                        .getHeader(Attributes.Rest.APP_ID, String.class)
                        .orElse("")),
                UUID.fromString(mqMetadata
                        .getHeader(Attributes.Rest.TASK_ID, String.class)
                        .orElse("")),
    ...
    public static TaskWebsocketDescription parseMessageFromWebsocket(Message<JsonObject> payload) {
        ...
        return new TaskWebsocketDescription(
                UUID.fromString(mqMetadata
                        .getHeader(Attributes.Websocket.USER_ID, String.class)
                        .orElse("")),
                ...
                UUID.fromString(mqMetadata
                        .getHeader(Attributes.Websocket.TASK_ID, String.class)
                        .orElse("")),
                mqMetadata
                        .getHeader(Attributes.Websocket.TASK_NAME, String.class)
                        .orElse(null),
                mapper.valueToTree(payload.getPayload()).toString());
    }

    public static void addRabbitTaskRest(
    ...
    public static void addRabbitTaskWebsocket(
            Emitter<String> emitter,
            String user,
            String socket,
            String target,

...
public class Utils {
    public static List<ParameterInput> addParameters(ParameterInput... parameterInput) {
        return new LinkedList<>(List.of(parameterInput));
    }

    public static <T> void addOptionalParameter(List<ParameterInput> parameters, String paramName, T value) {
        if (value != null) {
            parameters.add(new ParameterInput(paramName, value.toString()));
        }
    }

    public static <T> void addOptionalParameterArray(ArrayList<ParameterInput> parameter, String name, List<T> array) {
    ...
    public static <T> void addOptionalParameterArray(ArrayList<ParameterInput> parameter, String name, T[] array) {

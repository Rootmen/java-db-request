...
*/
public static Elements.QuerySet parseQuerySetNode(XMLStreamReader reader)
	...
	if (parserCode == XMLStreamConstants.START_ELEMENT && Nodes.PARAMETERS.equals(localName)) {
		Map<String, Elements.Parameter<?>> parameters =
			ParserEngineParameters.parseParametersNode(reader);
		...
		&& Nodes.QUERY_SET.equals(localName)) {
		break;
	}
	}
	return querySet;

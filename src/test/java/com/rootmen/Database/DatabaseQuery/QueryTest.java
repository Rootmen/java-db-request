...
public class QueryTest extends BaseTest {
    ...
    public void testGenerateOneQuery() throws Exception {
        ...
        Query query = new Query("1",
                new StringBuilder("SELECT $INT_VALUE$ as INT_VALUE, $STRING_VALUE$ as STRING_VALUE"),
                parameters);
    ...
    public void testGenerateQuery2() throws Exception {
        ...
        Query query = new Query("1",
                new StringBuilder("(SELECT $INT_VALUE$ as INT_VALUE, $INT_VALUE2$ as INT_VALUE2, $INT_VALUE$ as INT_VALUE3, $INT_VALUE2$ as INT_VALUE4, $STRING_VALUE1$ as STRING_VALUE1, $STRING_VALUE2$  as STRING_VALUE1 union all SELECT $INT_VALUE$ as INT_VALUE, $INT_VALUE2$ as INT_VALUE2, $INT_VALUE$ as INT_VALUE3, $INT_VALUE2$ as INT_VALUE4, $STRING_VALUE1$ as STRING_VALUE1, $STRING_VALUE2$  as STRING_VALUE1); SELECT $INT_VALUE$ as INT_VALUE, $INT_VALUE2$ as INT_VALUE2, $INT_VALUE$ as INT_VALUE3, $INT_VALUE2$ as INT_VALUE4, $STRING_VALUE1$ as STRING_VALUE1, $STRING_VALUE2$  as STRING_VALUE1;"),
                parameters);
        ...
        query = new Query("1",
                new StringBuilder("SELECT $INT_VALUE$ as INT_VALUE, $INT_VALUE2$ as INT_VALUE2, $INT_VALUE$ as INT_VALUE3, $INT_VALUE2$ as INT_VALUE4, $STRING_VALUE1$ as STRING_VALUE1, $STRING_VALUE2$  as STRING_VALUE1;"),
                parameters);

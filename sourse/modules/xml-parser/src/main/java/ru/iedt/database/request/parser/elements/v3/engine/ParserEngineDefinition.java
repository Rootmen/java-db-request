...
public class ParserEngineDefinition {
    ...
    public static Elements.Definition parseDefinitionNode(XMLStreamReader reader) throws XMLStreamException {
        ...
        while (reader.hasNext()) {
            ...
            if (Nodes.QUERY_SET.equals(localName)) {
                ...
                HashMap<String, Elements.Template> templates = ParserEngineTemplate.parseTemplatesNode(reader);
